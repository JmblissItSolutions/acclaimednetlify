...
import HomeOwnerPlans from "./homeowner-plans/HomeownerPlans"
import CheckOut from "./homeowner-plans/CheckOut";
import ResourcePage from "./Brochers/ResourcePage";
...
import HomeWarrantyProvider from "./landingpages/HomeWarrantyProvider";
            ...
            urlpath == '/texas-home-warranty'
              ...
              urlpath == '/arizona-home-warranty'
                ...
                urlpath == '/nevada-home-warranty'
                  ...
                  null
                  :
                  urlpath == '/home_warranty_provider'
                  ?
                  null
                  :
                  <SocialFollow />
        ...
        <div className="pagecontent">
          ...
          <ScrollToTop>
            <Switch>
              ...
              <Route path="/resources" component={ResourcePage} exact />
              <Route path="/homeowner-plans" component={HomeOwnerPlans} exact />
