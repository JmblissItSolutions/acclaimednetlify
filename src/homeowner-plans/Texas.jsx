...
const Texas = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Home Warrany Plans throughout Texas: What does a home warranty cover for Homeowners</title>
        <meta name="description" content="Acclaimed Home Warranty provides various coverage options to homeowners with different needs in Texas. Get in touch with us today for more details." />
        <meta name="keywords" content="home warranty texas, homeowner in texas warranty plans, real estate agen warranty plans in texas"/>
      </Helmet>
