                                            ...
                                            <fieldset>
                                                <div className="payment-method-form">
                                                    <p className="form-row form-row-wide">
                                                        ...
                                                        <input type="text" pattern="[0-9]" placeholder="Card Number" onChange={(e) => validateCreditCard(e.target.value)} />
                                                        <span style={{fontWeight: 'bold',color: 'red',position: 'absolute',top: '73px','font-size': '10px'}}>{errorMessage}</span>
                                                    </p>
                                                    <div>
