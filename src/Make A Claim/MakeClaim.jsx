  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="make a claim for my home warranty, how much does home warranties cost, acclaimed home warranty claim form"/>
      </Helmet>
        ...
        <div className="container">
          ...
          <div className="flex-container">
            <div className="box">
              ...
              <p><strong>A service fee is due for each item make on a claim.</strong></p>
            </div>
            <div className="box">
          ...
          <div className="form-box-wrap">
            ...
            <div className="form">
              <form>
                ...
                <label><input type="radio" value="No, this is not an emergency" onChange={(e) => { setEmergency(e.target.value) }} />No, this is not an emergency</label>
                <label><input type="radio" value="Yes, this is an emergencye" onChange={(e) => { setEmergency(e.target.value) }} /> Yes, this is an emergency</label>
