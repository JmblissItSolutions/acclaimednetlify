...
const AboutUs = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Acclaimed Home Warranty give homeowners the protection they need</title>
                <meta name="description" content="From expensive plumbing, roofing, and major appliance protection, home warranties give homeowners the home protection and coverage they need" />
                <meta name="keywords" content="water heater, home warranty plan, request service, real estate, customer service, claim online, home warranties cover, home systems and appliances, covered repairs"/>
            </Helmet>
