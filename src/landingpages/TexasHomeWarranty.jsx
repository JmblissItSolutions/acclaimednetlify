...
const TexasHomeWarranty =()=>{
    return(
        <>
        <Helmet>
            <title>Best Texas Home Warranty Providers</title>
            <meta name="description" content="What is the best home warranty company in Texas? Acclaimed Home Warranty at your service." />
            <meta name="keywords" content="texas home warranty, acclaimed hw, friendly texas home warranty company" />
        </Helmet>
