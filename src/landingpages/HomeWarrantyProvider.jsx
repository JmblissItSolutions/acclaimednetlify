...
const HomeWarrantyProvider =()=>{
    return(
        <>
            <Helmet>
                <title>Home Warranty Providers for Western US</title>
                <meta name="description" content="Acclaimed Home Warranty: Build home warranties into your real estate deal"/>
                <meta name="keywords" content="acclaimed home warranty, provides home repair coverage as part of the warranty"/>
            </Helmet>
