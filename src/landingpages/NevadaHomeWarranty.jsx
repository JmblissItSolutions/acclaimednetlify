...
const NevadaHomeWarranty =()=>{
    return(
        <>
        <Helmet>
            <title>Comprehensive Home Warranty service for Nevada Homeowners</title>
            <meta name="description" content="Acclaimed Home Warranty provides the most comprehensive home warranty in Nevada"/>
            <meta name="keywords" content="nevada home warranty provider, cover your home in nevada with acclaimed home warranty"/>
        </Helmet>
