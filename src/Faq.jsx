    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="keywords" content="how can we help you today, have questions about home warranties, we have answers to frequently asked questions about home warranty, can you customize your home warranty plan"/>
            </Helmet>
                        ...
                        <div className="col-md-6">
                            <div className="home_wranty">
                                <div className="inner_homewranty">
                                    ...
                                    <p>A service fee is similar to a deductible. Each time a claim is called in one will be required. Service fees differ state to state but range between $60-$75.</p><p><strong>A service fee is due for each item make on a claim.</strong></p>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-6">
