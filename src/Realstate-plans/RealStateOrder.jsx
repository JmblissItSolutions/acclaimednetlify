...
const RealStateOrder = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Add Home Warranty Coverage to Your Real Estate Transaction</title>
                ...
                <meta name="keywords" content="real estate home warranty, title agency home warranty, home warranty for real estate professionals"/>
            </Helmet>
