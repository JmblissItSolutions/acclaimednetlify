                                ...
                                <div className="form-box-wrap">
                                    ...
                                    <div className="renew-form">
                                        <form>
                                            ...
                                            <div className="evf-field-description">Payment: if you choose to renew on the same plan as last year we will email you an invoice to securely pay online. Once payment is made you will receive the updated contract information to your email to securely pay online.</div>
